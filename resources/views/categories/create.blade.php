                    ...
                    <div class="summary entry-summary">
                        ...
                        <p class="meta_description">
                            <span class="category-description-amount amount">
                                <bdi>
                                    <textarea name="meta_description" class="form-control" placeholder="Category Description"></textarea>
                                </bdi>
                            </span>
                        </p>
                        ...
                        <p class="meta_description">
                            <span class="category-description-amount amount">
                                <bdi>
                                    <textarea name="meta_keywords" class="form-control" placeholder="Category keywords"></textarea>
                                </bdi>
                            </span>
                        </p>
                        ...
                        <p class="meta_description">
                            <span class="category-description-amount amount">
                                <bdi>
                                    <textarea name="meta_title" class="form-control" placeholder="Category Title"></textarea>
                                </bdi>
                            </span>
                        </p>
                    </div>
