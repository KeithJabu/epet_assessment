        ...
        <div class="container">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <br>
                    @if (Auth::check())
                        <p><a class="btn btn-warning" href="/products/edit/{{ $product_item->id }}">Edit</a></p>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary"><a href="/product_variant/{{ $product_variant["id"] }}"> View </button>
